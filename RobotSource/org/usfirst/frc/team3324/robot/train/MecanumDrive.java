...
{
	public MecanumDrive(SpeedController flMotor, SpeedController blMotor, SpeedController frMotor, SpeedController brMotor)
	{
	...
	{
		return new Motion[] { Motion.FORWARD, Motion.BACKWARD, Motion.CLOCKWISE, Motion.COUNTER_CLOCKWISE, Motion.LEFT, Motion.RIGHT };
	}
